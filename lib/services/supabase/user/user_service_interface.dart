...
abstract class UserService {
  ...
  Future<Map<String, dynamic>> updateUserData(String userId, Map<String, dynamic> data);
  
  /// Creates a new user record in the Supabase 'users' table
  /// This is typically called after a new user signs up
  Future<Map<String, dynamic>> createUserData(String userId, Map<String, dynamic> data);
}
