...
class AppFilledButton extends FilledButton {
  ...
  /// Creates a filled button with a custom child, with optional loading state.
  /// 
  /// This constructor allows you to provide a completely custom [child] widget.
  /// If [isLoading] is true, the button will be disabled and show a loading indicator.
  AppFilledButton.custom({
    super.key,
    VoidCallback? onPressed,
    super.style,
    super.focusNode,
