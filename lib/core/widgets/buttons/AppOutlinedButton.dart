...
class AppOutlinedButton extends OutlinedButton {
  ...
  static AppOutlinedButton icon({
    ...
    return AppOutlinedButton.custom(
      key: key,
      onPressed: onPressed,
      style: style,
      focusNode: focusNode,
  ...
  /// Creates an outlined button with a custom child, with optional loading state.
  /// 
  /// This constructor allows you to provide a completely custom [child] widget.
  /// If [isLoading] is true, the button will be disabled and show a loading indicator.
  AppOutlinedButton.custom({
    super.key,
    VoidCallback? onPressed,
    super.style,
    super.focusNode,
