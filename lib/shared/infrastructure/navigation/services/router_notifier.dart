...
import 'package:flutter_mvvm_base/shared/presentation/widgets/forms/example_form_screen.dart';
import 'package:flutter_mvvm_base/shared/presentation/widgets/layouts/app_shell.dart';
import 'package:flutter_mvvm_base/shared/presentation/widgets/screens/error_screen.dart';
...
class RouterNotifier extends ChangeNotifier {
  ...
  String? redirect(BuildContext context, GoRouterState state) {
    ...
    final isGoingToPublicRoute =
        RoutePaths.isPublicRoute(state.matchedLocation);
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () =>
                  context.go('${RoutePaths.nestedFeatureDetail}/123'),
